void keyPressed() {
  switch(key) {
    ...
    //Checks cell before playing
      if (isGameRunning == true && board[0] == 'X' || board[0] == 'O' && humanTurns < 4 && win == 0) {
    ...
    break;
    case '1':
       if (isGameRunning == true && board[1] == 'X' || board[1] == 'O' && humanTurns < 4) {
        println("Cell already taken, please choose an open cell.");
        isHumanTurn = true;
      }
      else if (isGameRunning == true){
    ...
    break;
    case '2':
      if (isGameRunning == true && board[2] == 'X' || board[2] == 'O' && humanTurns < 4) {
        println("Cell already taken, please choose an open cell.");
        isHumanTurn = true;
      }
      else if (isGameRunning == true){
    ...
    break;
    case '3':
      if (isGameRunning == true && board[3] == 'X' || board[3] == 'O' && humanTurns < 4) {
        println("Cell already taken, please choose an open cell.");
        isHumanTurn = true;
      }
      else if (isGameRunning == true){
    ...
    break;
    case '4':
      if (isGameRunning == true && board[4] == 'X' || board[4] == 'O' && humanTurns < 4) {
        println("Cell already taken, please choose an open cell.");
        isHumanTurn = true;
      }
      else if (isGameRunning == true){
    ...
    break;
    case '5':
      if (isGameRunning == true && board[5] == 'X' || board[5] == 'O' && humanTurns < 4) {
        println("Cell already taken, please choose an open cell.");
        isHumanTurn = true;
      }
      else if (isGameRunning == true){
    ...
    break;
    case '6':
      if (isGameRunning == true && board[6] == 'X' || board[6] == 'O' && humanTurns < 4) {
        println("Cell already taken, please choose an open cell.");
        isHumanTurn = true;
      }
      else if (isGameRunning == true){
    ...
    break;
    case '7':
      if (isGameRunning == true && board[7] == 'X' || board[7] == 'O' && humanTurns < 4) {
        println("Cell already taken, please choose an open cell.");
        isHumanTurn = true;
      }
      else if (isGameRunning == true){
    ...
    break;
    case '8':
      if (isGameRunning == true && board[8] == 'X' || board[8] == 'O' && humanTurns < 4) {
        println("Cell already taken, please choose an open cell.");
        isHumanTurn = true;
      }
      else if (isGameRunning == true){
